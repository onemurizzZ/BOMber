export const INDEXABLE_ROBOTS_TAG =
  "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1";

export function createBaseHeaders(headers?: HeadersInit): Headers {
...
export function createLlmsFullTxt(origin: string): string {
...
export function withSeoHeaders(response: Response, origin: string): Response {
